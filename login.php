...
<div id="main-wrapper">
  <div class="unix-login">
    ...
    <div class="container-fluid" style="background-image: url('assets/uploadImage/Logo/banner3.png');
                ">
      <div class="row ">
        <div class="col-md-4">
          <div class="login-content ">
            <div class="login-form">
              <img class="img" src="./assets/uploadImage/Logo/ban.png" style="width: 250px; margin-left: 20%">
